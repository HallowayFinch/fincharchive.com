---
layout: log
title: "The Angle Deviation Study"
log_id: "1022H"
date: "2025-11-22T04:22:36+00:00"
source_url: "https://www.hallowayfinch.com/p/the-angle-deviation-study"
guid: "/p/the-angle-deviation-study"
permalink: "/logs/the-angle-deviation-study/"
hero_image: "https://substack-post-media.s3.amazonaws.com/public/images/cde08bc1-6504-48f7-8753-f40fb75af92f_1200x675.png"
---
I signed out the inspection camera at 09:14.
Model: FC-3 FieldCam, second generation, standard wide-angle lens, last serviced 2023-08-02.
Unit condition: acceptable; minor scuffing on housing, lens clean.
...
I took another photo immediately afterward, this time bracing the camera with both hands. I said aloud:
“Centered. Confirmed.”
My spoken notes marked the moment for later sorting.
...
I photographed a safety placard mounted to the wall.
Then the fire door.
Then a floor drain.
Then a spot where mildew had etched faint crescents into the paint.

Every single photo rotated subtly toward the far northwest corner of the room.
Always that same corner.

I took a dozen more.

The drift increased.

Two degrees. Four. Six.
By the fifteenth photo it was nearly ten degrees.
...
2240-C: Observation 03
Suspicion: field camera orientation not matching optical aim.
Deviation appears non-linear; always resolves toward NW corner.
Instrument error improbable; evaluate onboard accelerometers later.
...
The northwest corner was lined with metal shelving coated in dust.
Stacks of old inspection forms curled from humidity.
An unplugged dehumidifier stood against the wall.
...
This wasn’t drift.
This wasn’t angle.
This was an intrusion of something that should not be in the frame.
...
I aimed at a conduit clamp near the ceiling.
Thermal display: normal.

Captured image: rotated nine degrees toward the corner.

I aimed directly at the floor.
Thermal display: normal.

Captured image: rotated toward the corner.

I finally aimed at the corner itself, watching the thermal viewfinder carefully.
Cold, uniform.
Nothing anomalous.
...
On playback, the image showed the corner clearly at last.
Centered.
Straight.
No rotational drift.
...
But visible in the photo of the mirror.

As if the act of recording had expanded the room by a few inches in a direction the eye could not perceive.

The mirror had shown more than the camera.
Or the camera had shown more than the room.

I lowered the device.
The overhead fixture flickered once.

I sealed the camera in an evidence bag at 11:03.
Two minutes later, the fixture stabilized.
The air temperature climbed by 0.2°C.

My final note:

2240-C: Observation 11
Drift resolved when using indirect optical path.
Reflection captured spatial detail not visible to observer.
Corner may represent non-Euclidean boundary.
Suggest quarantine of Sub-Basement 4B pending geometric assessment.
